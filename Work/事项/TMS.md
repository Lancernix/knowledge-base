...
| 错误                                                                                                                                                      | 页面                                                                                                                                 | 进度          | 备注       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------- |
| TypeError: Cannot read properties of undefined (reading 'map')                                                                                          | /onOmsSystem/requirementOrderManage/requirementOrderDetail?pre_order_id=117258725733200003&customer_order_code=ERP 和实 202400909008 | #NotStarted | 有点多，后面排查 |
| TypeError: t[n.label].indexOf is not a function                                                                                                         | /rule/orderAutoRule                                                                                                                | #NotStarted | 有点多，后面排查 |
